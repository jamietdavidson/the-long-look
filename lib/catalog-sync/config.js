...
export const AIRTABLE = {
  ...
  /** Artists/Collections Status single-select spelling in Airtable (Prints/Variants use committedStatus). */
...
/** Status value written after a successful sync, per table. */
export function committedStatusForTable(tableKey) {
  if (tableKey === 'artists' || tableKey === 'collections') {
    return AIRTABLE.linkedCommittedStatus;
  }
  return AIRTABLE.committedStatus;
}
