...
export function buildProductInput({
  ...
  const input = {
    ...
    variants: catalog.map((variant) => {
      ...
      metafields: [
        {namespace: mf.namespace, key: mf.shortInches, type: 'number_decimal', value: String(sizing.shortSide)},
        {namespace: mf.namespace, key: mf.longInches, type: 'number_decimal', value: String(sizing.longSide)},
        {namespace: mf.namespace, key: mf.paddingInches, type: 'number_decimal', value: String(sizing.referencePadding)},
        {namespace: mf.namespace, key: mf.frameWidthInches, type: 'number_decimal', value: String(sizing.frameWidth)},
        {namespace: mf.namespace, key: mf.rank, type: 'number_integer', value: String(sizing.rank)},
      ],
    };
    }),
  };
...
function buildVariantMetafields(variant, sizingMap) {
  const mf = SHOPIFY.metafields;
  const sizing = canonicalVariantMetafieldSizing(variant, sizingMap);
  return [
    {
